...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button cameraButton,
      @NonNull Button galleryButton, @NonNull TextInputLayout inputLayout,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, cameraButton, galleryButton,
          inputLayout, previewImageView, progressIndicator, uploadButton);
    }
